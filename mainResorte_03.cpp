...
int main(void)
{
    ...
    */
	...
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE,
		sizeof(int), (void*)(sizeof(float) * 3)); // decia 2
*/
...
//BUFFERS
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(VERTICE), (void*)0); //vertices
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(VERTICE), (void*)(3*sizeof(float))); //color
...
/*
    ...
    mat4x4_perspective(pers, 20.0 * atan(1.0) / 45.0, 800.0 / 600.0,
        0.0f, 10.0f);
    ...
    for (int t = 0; t < 2; t++)
    {
        ...
        //glUseProgram(program);
        glUniformMatrix4fv(mvp_location, 1, GL_FALSE, (const GLfloat*)mvp);
        //glDrawArrays(GL_TRIANGLES, 0, 12); // glDrawArrays(GL_TRIANGLES, 0, 3);
        //glDrawArrays(GL_LINE_LOOP, 0, 12); // glDrawArrays(GL_TRIANGLES, 0, 3);
        // pinta las caras
        glDrawElements(GL_TRIANGLES, num_indices, GL_UNSIGNED_INT, 0);
